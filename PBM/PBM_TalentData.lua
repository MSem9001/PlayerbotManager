...
--  à placer dans   Interface/AddOns/PBM/PBMTalent.lua
--  juste après le bloc   PBM.data.talent.glyphs = { … }
-- =========================================================================
PBM.data.talent.specGlyphs = {
    WARRIOR = {      -- 1.x
...
do
    ...
    for upperKey, tbl in pairs(PBM.data.talent.specGlyphs) do
    ...
    PBM.data.talent.specGlyphs = unified
end
